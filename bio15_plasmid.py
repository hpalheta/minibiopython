...
'''
    ...
    Programa  : bio15_plasmid.py
    Homepage  : http://www
    Autor     : Biopython

    Execução:
      python  bio15_plasmid.py
...
for site, name, color in [("GAATTC","EcoRI",colors.green), ("CCCGGG","SmaI",colors.orange),  ("AAGCTT","HindIII",colors.red), ("GGATCC","BamHI",colors.purple)]:
	index = 0
	while True:
